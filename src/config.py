...
# --- Font Files ---
FONT_EB_GARAMOND_BOLD = os.getenv("FONT_EB_GARAMOND_BOLD", "fonts/EBGaramond-Bold.ttf")
...
TEMPLATE_PDF_FILES: dict[str, str] = {
    "avery5160": "pdf-templates/avery-5160.pdf",
...
SYMBOL_CACHE_DIR = Path(os.getenv("SYMBOL_CACHE_DIR", "static/images"))
